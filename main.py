...
def spanish_and_brazilian_fruits(spanish_fruits, brazilian_fruits):
    intersection = spanish_fruits & brazilian_fruits
...
def spanish_and_japan_fruits(spanish_fruits, japanese_fruits):
    intersection = spanish_fruits & japanese_fruits
...
def brazilian_and_japan_fruits(brazilian_fruits, japanese_fruits):
    intersection = brazilian_fruits & japanese_fruits
...
def popular_spanish_or_brazilian_fruits(popular_fruits, spanish_fruits, brazilian_fruits):
    union = brazilian_fruits | spanish_fruits
    intersection = popular_fruits & union
...
def popular_only_spanish_fruits(popular_fruits, spanish_fruits, japanese_fruits, brazilian_fruits):
    union = brazilian_fruits | japanese_fruits
    difference = spanish_fruits - union
    intersection = popular_fruits & difference
...
def only_yahoo_emails(emails_list):
    yahoo = set([email for email in emails_list if email.lower().endswith('yahoo.com') or email.lower().endswith('yahoo.com.br') or email.lower().endswith('yahoo.com.com.br')])
...
def only_hotmail_emails(emails_list):
    hotmail = set([email for email in emails_list if email.lower().endswith('hotmail.com') or email.lower().endswith('hotmail.com.br')])
...
def only_br_emails(emails_list):
    br = set([email for email in emails_list if email.lower().endswith('br')])
